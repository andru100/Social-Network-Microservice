...
func GetLikes(ctx context.Context, in *GetPost) (*MongoFields, error) { // gets comments for all friends/users, for the home page feed
	...
	for _, data := range userdata.Liked {
		record := MongoFields{}
