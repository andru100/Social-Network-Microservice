...
func CreateAccount (username string) error {
	...
	createuser := MongoFields{Username: username, Profpic: "https://adminajh46unique.s3.eu-west-2.amazonaws.com/default-profile-pic.jpg", Photos: []string{},  Posts: []*PostData{}, Following: []string{}, Followers: []string{}, Replys: []*ReplyData{}, Liked: []*LikedData{}}
